#
# Module manifest for module 'PSWinDocumentation.AzureHealthService'
#
...
@{
    ...
    RootModule           = 'PSWinDocumentation.AzureHealthService.psm1'
    ...
    RequiredModules      = @(@{ModuleName = 'PSParseHTML'; GUID = 'f0387960-7034-4918-a1e1-d5847cbf90df'; ModuleVersion = '0.0.12'; })
    ...
    FunctionsToExport    = 'Get-WinAzureHealth'
